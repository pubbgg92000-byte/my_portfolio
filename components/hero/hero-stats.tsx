...
export function HeroStats() {
  return (
    <div className="hero-reveal mt-8 grid grid-cols-2 overflow-hidden rounded-2xl border border-white/10 bg-black/28 backdrop-blur-xl sm:grid-cols-4 lg:grid-cols-2 xl:grid-cols-4">
      {heroStats.map((stat) => (
